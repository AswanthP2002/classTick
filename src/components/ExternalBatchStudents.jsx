            ...
            isPresent && (
                        <div className="grid gap-3 !mt-3">
                            <div className="flex gap-3">
                                ...
                                <div>
                                <input value={batch} onChange={(event) => setBatch(event.target.value)} type="text" name="" id="" placeholder="batch" className="border border-gray-200 w-[100px] rounded !text-sm !px-2 !outline-none" />
